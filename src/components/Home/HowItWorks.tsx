    ...
    const steps = [
        {
            ...
            icon: FaDoorOpen,
            title: "Create a Room",
            desc: "Click 'Create New Room' to generate a unique 6-character room ID that you can share with your team.",
            color: "primary",
        },
        {
            step: 2,
                    ...
                    {steps.map((item, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div
                                    className={`relative mb-6 w-24 h-24 rounded-full flex items-center justify-center bg-${item.color} text-${item.color}-content shadow-lg transform group-hover:scale-110 transition-all duration-300`}
                                >
                                    <div className="text-4xl">
                                        <Icon />
                                    </div>
                                    <div
                                        className={`absolute -top-2 -right-2 badge badge-lg badge-${item.color} border-2 border-base-100`}
                                    >
                                        {item.step}
                                    </div>
                                </div>
